  ...
  <LegalLayout title="Politique de Confidentialité" lastUpdated="22 Avril 2025">
    ...
    <Section title="Article 3 – Données collectées">
      ...
      <ul className="list-disc pl-5 space-y-1">
        ...
        <li><strong>Données de commande</strong> : articles commandés, montants, historique d'achats</li>
    ...
    <Section title="Article 5 – Durée de conservation">
      <p>Conformément à l'article 24 de la Loi n° 2008-12, vos données sont conservées pour les durées suivantes :</p>
      <ul className="list-disc pl-5 space-y-1">
    ...
    <Section title="Article 6 – Partage des données">
      ...
      <ul className="list-disc pl-5 space-y-1">
        <li>Nos prestataires de livraison, dans le strict cadre de l'exécution de vos commandes</li>
    ...
    <Section title="Article 7 – Vos droits">
      ...
      <ul className="list-disc pl-5 space-y-1">
        ...
        <li><strong>Droit d'opposition</strong> : s'opposer au traitement de vos données à des fins marketing</li>
    ...
    <Section title="Article 8 – Cookies">
      <p>Notre site utilise des cookies fonctionnels essentiels au bon fonctionnement de la boutique (panier, session). Aucun cookie publicitaire tiers n'est utilisé sans votre consentement explicite, conformément aux recommandations de la CDP.</p>
    </Section>

    <Section title="Article 9 – Sécurité">
      <p>Rahima Store met en œuvre des mesures techniques et organisationnelles appropriées pour protéger vos données contre tout accès non autorisé, perte ou divulgation, conformément à l'article 25 de la Loi n° 2008-12.</p>
    </Section>
  </LegalLayout>
);
