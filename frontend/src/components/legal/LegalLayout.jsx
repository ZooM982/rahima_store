...
const LegalLayout = ({ title, lastUpdated, children }) => {
  ...
  return (
    <div className="pt-24 pb-20 md:pt-32 custom-container relative overflow-hidden min-h-screen">
      <DecorativePictogram className="top-40 -left-20 rotate-12 opacity-[0.05]" size="w-[600px] h-[600px]" />
      <DecorativePictogram className="bottom-0 -right-20 -rotate-45 opacity-[0.1]" size="w-80 h-80" />
      <SEO
        title={title}
